<script lang="ts">
	...
	export let listCommands: Commands = window.CONFIG.commands;
</script>

<div
	class="mx-10 grid auto-cols-max auto-rows-max grid-cols-4 grid-rows-4 gap-x-2 text-lg transition-all duration-500 ease-in"
	class:hidden={!show}
>
